...
PRIVATE void SynthWindow80_generated(OI_INT16 *pcm, SBC_BUFFER_T const * RESTRICT buffer, OI_UINT strideShift)
{
    ...
    /* 1 - stage 0 */ pcm_b +=(MUL_16S_16S(-17397, buffer[ 36])) * 2;
    /* 1 - stage 0 */ pcm_b +=(MUL_16S_16S(9399, buffer[ 44])) * 8;
    /* 1 - stage 0 */ pcm_b +=(MUL_16S_16S(17397, buffer[ 52])) * 2;
    ...
    /* 1 - stage 1 */ pcm_b +=(MUL_16S_16S(1247, buffer[ 21])) * 8;
    /* 1 - stage 1 */ pcm_a +=(MUL_16S_16S(30835, buffer[ 27]))>> 3;
    /* 1 - stage 1 */ pcm_b +=(MUL_16S_16S(-2893, buffer[ 27])) * 8;
    /* 1 - stage 1 */ pcm_a +=(MUL_16S_16S(-27021, buffer[ 37])) * 2;
    /* 1 - stage 1 */ pcm_b +=(MUL_16S_16S(23671, buffer[ 37])) * 4;
    /* 1 - stage 1 */ pcm_a +=(MUL_16S_16S(31633, buffer[ 43])) * 2;
    /* 1 - stage 1 */ pcm_b +=(MUL_16S_16S(18055, buffer[ 43])) * 2;
    /* 1 - stage 1 */ pcm_a +=(MUL_16S_16S(17319, buffer[ 53])) * 2;
    /* 1 - stage 1 */ pcm_b +=(MUL_16S_16S(11537, buffer[ 53]))>> 1;
    /* 1 - stage 1 */ pcm_a +=(MUL_16S_16S(26663, buffer[ 59]))>> 2;
    /* 1 - stage 1 */ pcm_b +=(MUL_16S_16S(1747, buffer[ 59])) * 2;
    /* 1 - stage 1 */ pcm_a +=(MUL_16S_16S(4555, buffer[ 69]))>> 1;
    /* 1 - stage 1 */ pcm_b +=(MUL_16S_16S(685, buffer[ 69])) * 2;
    ...
    /* 1 - stage 2 */ pcm_a +=(MUL_16S_16S(-309, buffer[ 22])) * 16;
    /* 1 - stage 2 */ pcm_b +=(MUL_16S_16S(1917, buffer[ 22])) * 4;
    /* 1 - stage 2 */ pcm_a +=(MUL_16S_16S(9161, buffer[ 26]))>> 3;
    /* 1 - stage 2 */ pcm_b +=(MUL_16S_16S(-30605, buffer[ 26]))>> 1;
    /* 1 - stage 2 */ pcm_a +=(MUL_16S_16S(-23063, buffer[ 38])) * 2;
    /* 1 - stage 2 */ pcm_b +=(MUL_16S_16S(8317, buffer[ 38])) * 8;
    /* 1 - stage 2 */ pcm_a +=(MUL_16S_16S(27561, buffer[ 42])) * 2;
    /* 1 - stage 2 */ pcm_b +=(MUL_16S_16S(9553, buffer[ 42])) * 4;
    /* 1 - stage 2 */ pcm_a +=(MUL_16S_16S(2309, buffer[ 54])) * 8;
    ...
    /* 1 - stage 3 */ pcm_b +=(MUL_16S_16S(3687, buffer[ 23])) * 2;
    /* 1 - stage 3 */ pcm_a +=(MUL_16S_16S(-29015, buffer[ 25]))>> 4;
    /* 1 - stage 3 */ pcm_b +=(MUL_16S_16S(-301, buffer[ 25])) * 32;
    /* 1 - stage 3 */ pcm_a +=(MUL_16S_16S(-12889, buffer[ 39])) * 4;
    /* 1 - stage 3 */ pcm_b +=(MUL_16S_16S(15447, buffer[ 39])) * 4;
    /* 1 - stage 3 */ pcm_a +=(MUL_16S_16S(6145, buffer[ 41])) * 8;
    /* 1 - stage 3 */ pcm_b +=(MUL_16S_16S(10255, buffer[ 41])) * 4;
    ...
    /* 1 - stage 4 */ pcm_a +=(MUL_16S_16S(-5297, buffer[ 24])) * 2;
    /* 1 - stage 4 */ pcm_a +=(MUL_16S_16S(22299, buffer[ 40])) * 4;
